...
figures/gen_rgb2pc_gallery_pct.py; the control gets its own colour so the two generated
columns can be told apart.

  python figures/gen_rgb2pc_arm_compare.py --out vis_gallery/arm_compare_smr50_vs_smr00.png
"""
