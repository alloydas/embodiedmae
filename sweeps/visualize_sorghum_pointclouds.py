...
Usage:
    python sweeps/visualize_sorghum_pointclouds.py --data_root /path/to/dataset --save_dir ./viz_out
    python sweeps/visualize_sorghum_pointclouds.py --data_root /path/to/dataset --save_dir ./viz_out --plant Sorghum_3
    python sweeps/visualize_sorghum_pointclouds.py --data_root /path/to/dataset --save_dir ./viz_out --subsample 20000
"""
