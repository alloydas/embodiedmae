...
by figures/regen_figures.py's second section:
...
def main():
    ...
    # figures/regen_figures.py passed the val directory as data_root with split=None; the
    ...
    # Built and loaded BEFORE the seed, exactly as in figures/regen_figures.py, so the
    ...
    out = {
        ...
        'rows': [row],
        'note': ("Replays figures/regen_figures.py's pretrain leg, which produced the static plate "
