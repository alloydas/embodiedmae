...
The static plate on the results page is figures/gen_rgb2pc_gallery.py's output: eight
...
Caveat on the numbers.  figures/gen_rgb2pc_gallery.py never seeds numpy, and
...
def main():
    ...
    out = dict(
        ...
        note=('Same eight validation folders as the static plate: '
              'figures/gen_rgb2pc_gallery.py --split val --n 8 --stride 137, indices '
