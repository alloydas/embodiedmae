...
the page footer credits `figures/make_rgb2pc_figure.py`, but that script renders four
...
def main():
    ...
    out = {
        ...
        'note': ('The static plate is four crops from the training visualiser '
                 ...
                 'outputs/4m_distill_15k_rgb2pc_full run, not from figures/make_rgb2pc_figure.py, '
