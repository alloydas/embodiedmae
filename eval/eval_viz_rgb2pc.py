"""
eval/eval_viz_rgb2pc.py — visualise what the RGB→PC distilled model actually produces,
...
Usage:
    python eval/eval_viz_rgb2pc.py --checkpoint outputs/4m_distill_rgb2pc/best_model.pth \
