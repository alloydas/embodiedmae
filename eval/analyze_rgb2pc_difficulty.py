...
out of eyeballing figures/gen_rgb2pc_gallery_pct.py, whose worst rows all looked top-down.
...
Usage:
    python eval/analyze_rgb2pc_difficulty.py            # uses/creates the feature cache
    python eval/analyze_rgb2pc_difficulty.py --rebuild  # re-reads the 2250 .ply files
"""
