...
gen_rgb2pc_gallery_pct.py answers "how well does it score" by spanning the error
...
Defaults reproduce vis_gallery/smr50_multiview.png:
    python gen_rgb2pc_multiview.py --device cpu
"""
...
def camera_elevation(folder):
    ...
    same quantity plot_view_elevation_effect.py puts on its x axis. The camera
